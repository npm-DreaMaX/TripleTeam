...
export declare const cjkPunctuationRegex: RegExp;
export declare const autocompleteSeparatorRegex: RegExp;
export declare const autocompleteBoundaryRegex: RegExp;
/**
